...
function Card({ product }) {
  return (
    <div
      key={product.id}
      className="card-container w-full max-w-sm bg-white border rounded-lg shadow shadow-lg shadow-purple-800/50 border-purple-500 relative top-0 left-0 transition-transform duration-300 transform hover:scale-105"
    >
      <Link to="#">
        <img
